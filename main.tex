...
- Email đã tồn tại: Hệ thống báo lỗi và yêu cầu đăng nhập. \newline
...
\begin{longtable}{|p{3.5cm}|p{11.5cm}|}
\hline
\textbf{UC-06} & \textbf{Tương tác bài viết (Like/Comment)} \\
\hline
\textbf{Mô tả} & Người dùng thể hiện cảm xúc (Tim) hoặc bình luận vào bài viết của người khác. \\
\hline
\textbf{Tác nhân} & Người dùng. \\
\hline
\textbf{Tiền điều kiện} & Đang xem bài viết trên Newsfeed hoặc xem chi tiết. \\
\hline
\textbf{Sự kiện kích hoạt} & Nhấn vào icon Trái tim hoặc icon Bình luận. \\
\hline
\textbf{Luồng cơ bản} & 
...
3. Hệ thống gửi thông báo (Notification) đến chủ nhân bài viết. \\
\hline
\textbf{Luồng ngoại lệ} & 
...
2. Người dùng nhập tin nhắn, gửi ảnh/sticker. \newline
3. Hệ thống chuyển tin nhắn đến người nhận ngay lập tức (thông qua Socket). \newline
4. Hệ thống hiển thị trạng thái ``Đã xem'' khi người nhận mở tin nhắn. \\
\hline
...
\textbf{Tác nhân} & Người dùng. \\
\hline
\textbf{Tiền điều kiện} & Vào mục Explore -> Chọn ``Tình huống''. \\
\hline
\textbf{Luồng cơ bản} & 
...
4. Hiển thị popup thông báo số ngày Streak và điểm thưởng nhận được. \\
\hline
...
\hline
\textbf{Mô tả} & Cho phép người dùng thay đổi biểu tượng App trên màn hình chính điện thoại dựa trên cấp độ Streak. \\
\hline
\textbf{Tác nhân} & Người dùng. \\
\hline
\textbf{Tiền điều kiện} & Đạt đủ mốc Streak quy định (7 ngày, 30 ngày...). \\
\hline
\textbf{Luồng cơ bản} & 
1. Người dùng vào Profile -> Cài đặt -> Đổi Icon. \newline
2. Hệ thống hiển thị danh sách Icon (Có khóa và Đã mở khóa). \newline
3. Người dùng chọn Icon đã mở khóa. \newline
4. Hệ thống thực hiện thay đổi Icon (sử dụng tính năng `activity-alias` của Android). \\
\hline
...
2. Hệ thống hiển thị bộ bài úp. \newline
3. Người dùng chọn 1 lá bài. \newline
4. Hệ thống lật bài và hiển thị lời giải thích (Meaning) về tình duyên trong ngày. \\
\hline
\textbf{Hậu điều kiện} & Ghi nhận lượt xem trong ngày. \\
\hline
\end{longtable}
\clearpage
